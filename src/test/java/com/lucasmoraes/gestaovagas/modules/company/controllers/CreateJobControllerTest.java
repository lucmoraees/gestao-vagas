...
import static com.lucasmoraes.gestaovagas.utils.TesteUtils.generateToken;
import static com.lucasmoraes.gestaovagas.utils.TesteUtils.objectToJson;
...
public class CreateJobControllerTest {
    ...
    public void should_be_able_to_create_a_new_job() throws Exception{
        ...
        var result = mvc.perform(MockMvcRequestBuilders.post("/company/job")
                        ...
                        .header("Authorization", generateToken(company.getId(), "JAVA_VAGAS_123@@"))
                )
    ...
    public void should_not_be_able_to_create_a_new_job_if_company_not_found() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/company/job")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectToJson(createdJobDTO))
                .header("Authorization", generateToken(UUID.randomUUID(), "JAVA_VAGAS_123@@")))
